...
//                child("Users").child("Customers").child(onlineDriverID);
    ...
    private void SignInDriver(String email, String password) {
        ...
        if (TextUtils.isEmpty(password)){
            ...
            loadingBar.setTitle("Mechanic SignIn");
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(DriverLoginRegisterActivity.this,"You have  successfullly logged in",Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful())
                            {
                                ...
                                Intent driverIntent=new Intent(DriverLoginRegisterActivity.this, DriverMapActivity.class);
                                startActivity(driverIntent);
                                Toast.makeText(DriverLoginRegisterActivity.this,"You have registered successfullly",Toast.LENGTH_SHORT).show();
                             loadingBar.dismiss();
                            ...
                            else
                                {
                                  ...
                                  Toast.makeText(DriverLoginRegisterActivity.this,"Registration Failed",Toast.LENGTH_SHORT).show();
                                  loadingBar.dismiss();
                                }
